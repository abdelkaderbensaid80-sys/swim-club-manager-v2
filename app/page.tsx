    ...
    <div className="min-h-screen bg-[#0a192f] text-white overflow-hidden relative" dir="rtl">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center h-[80vh] text-center px-4">
        <h1 className="text-6xl md:text-7xl font-black mb-6 tracking-tighter leading-tight">
          درب <span className="text-blue-400 text-glow">بذكاء</span><br/>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <Link 
            href="/onboarding" 
            className="bg-blue-600 hover:bg-blue-500 text-white px-12 py-5 rounded-full font-bold text-xl shadow-2xl shadow-blue-500/40 transition-all transform hover:-translate-y-1"
          >
            {"ابدأ الآن مجاناً"}
          </Link>
          <Link 
